...
package SAMD21_SVD.PORT_IOBUS is
   pragma Preelaborate;
   ...
   type PMUX_Register is record
      --  Peripheral Multiplexing Even
      PMUXE : PMUX0_PMUXESelect := SAMD21_SVD.PORT_IOBUS.A;
      --  Peripheral Multiplexing Odd
      PMUXO : PMUX0_PMUXOSelect := SAMD21_SVD.PORT_IOBUS.A;
   end record
   ...
   PORT_IOBUS_Periph : aliased PORT_IOBUS_Peripheral
     with Import, Address => PORT_IOBUS_Base;

end SAMD21_SVD.PORT_IOBUS;
